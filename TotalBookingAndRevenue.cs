...
namespace Travel_Ease
{
    ...
    {
        public int OperatorID { get; set; } // So that traveler is retained when returning home
        const string reportPath = "Hotel_and_Transport.TripBookingRevenueReport.rdlc";
        ...
        private void btnHome_Click(object sender, EventArgs e)
        {
            ...
            Operator op = new Operator(this.OperatorID);
            op.Show();
            this.Hide();
        }
        ...
        private void TotalBookingAndRevenue_Load(object sender, EventArgs e)
        {
