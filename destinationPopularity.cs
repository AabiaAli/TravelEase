...
namespace Travel_Ease
{
    public partial class destinationPopularity : Form
    {
        ...
        public int ID { get; set; } //so that traveler is retained when returning home, can be changed to whoever's id's interface this report is in and you can set it using the object created
        /*for example:
         ...
         */
        const string reportPath = "Hotel_and_Transport.DestinationPopularityReport.rdlc";
        ...
        private void btnHome_Click(object sender, EventArgs e)
        {
            ...
            {
                Operator op = new Operator(this.ID);
                op.Show();
                this.Hide();
            }
            if (userType == "Traveler")
            {
                travelerHome op = new travelerHome(this.ID);
                op.Show();
                this.Hide();
            }
            if (userType == "Hotel")
            {
                HotelDashboard h = new HotelDashboard(this.ID);
                h.Show();
                this.Hide();
            }
            if (userType == "Transport")
            {
                TransportDashboard h = new TransportDashboard(this.ID);
                h.Show();
                this.Hide();
            }
            if (userType == "Guide")
            {
                GuideDashboard h = new GuideDashboard(this.ID);
                h.Show();
                this.Hide();
            }
        ...
        private void destinationPopularity_Load(object sender, EventArgs e)
        {
