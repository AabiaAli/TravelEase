...
{
    public partial class GuideLogin : Form
    {
        public GuideLogin()
        {
            InitializeComponent();
        ...
        private void GuideLogin_Load(object sender, EventArgs e)
        {
        ...
        private void loginButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string queryCheck = "SELECT * FROM ServiceProvider " +
                                   ...
                                   "AND ProviderType = 2 AND SpStatus = 'Approved'";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    string query2 = "SELECT ProviderID FROM ServiceProvider WHERE Email = @email AND Password = @password AND ProviderType = 2 AND SpStatus = 'Approved'";
                    ...
                    {   // pass the login ID aagay to the home/dashboard
                        ...
                        GuideDashboard dashboard = new GuideDashboard(providerId);

                        ///// This is for the Active user report
                        string ActiveUserquery = "Insert into ActiveUsers values (@pID, 'Guide', getDate())";
        ...
        {
            GuideSignup form = new GuideSignup();
            form.Show();
            this.Hide();
        }
    }
