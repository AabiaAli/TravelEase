...
namespace Travel_Ease
{
    public partial class PackageCard : UserControl
    {
        ...
        public void SetData(string title, string description, string destinationName, string destinationCity, string destinationCountry, string accommodation,
                            ...
                            string susScore, string duration, string price)
        {
            ...
            lblDestination.Text = $"{destinationName}: {destinationCity}, {destinationCountry}"; //new: includes destination name
        ...
        private void lblGroupSize_Click(object sender, EventArgs e)
        {

        }

        private void lblSusScore_Click(object sender, EventArgs e)
        {
        ...
        private void lblBasePrice_Click(object sender, EventArgs e)
        {

        }

        private void lblTripType_Click(object sender, EventArgs e)
        {
